...
export default function LoginPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    if (!registerForm.password) {
      ...
      fieldErrors.password = 'Mot de passe trop court (min 8 caractères)'
    }
    ...
    try {
      ...
      if (response?.tokens && response?.user) {
        ...
        resetForms()
        toast.success(response?.message || `Bienvenue, ${response.user.name || response.user.email} !`)
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-3 py-2.5 rounded-xl border ${errors.name ? 'border-red-400' : 'border-gray-200 dark:border-gray-700'} bg-gray-50 dark:bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/30`}
                    required
                  />
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="votre@email.com"
                  className={`w-full px-3 py-2.5 rounded-xl border ${errors.email ? 'border-red-400' : 'border-gray-200 dark:border-gray-700'} bg-gray-50 dark:bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/30`}
                  required
                />
                {errors.email && <p className="text-red-500 text-xs mt-1">{errors.email}</p>}
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="••••••••"
                    className={`w-full pr-24 px-3 py-2.5 rounded-xl border ${errors.password ? 'border-red-400' : 'border-gray-200 dark:border-gray-700'} bg-gray-50 dark:bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/30`}
                    required
                    minLength={8}
                  />
                  <button
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="••••••••"
                    className={`w-full pr-24 px-3 py-2.5 rounded-xl border ${errors.confirmPassword ? 'border-red-400' : 'border-gray-200 dark:border-gray-700'} bg-gray-50 dark:bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/30`}
                    required
                  />
                  <button
                    type="button"
